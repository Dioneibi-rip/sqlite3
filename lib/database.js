...
module.exports = function createDatabase(getAddon, allowNativeBinding) {
	function Database(filenameGiven, options) {
		...
		const profile = 'profile' in options ? options.profile : 'default';
		...
		if (profile !== 'default' && profile !== 'ruby-hoshino') throw new TypeError('Expected the "profile" option to be "default" or "ruby-hoshino"');
		...
		Object.defineProperties(this, {
			[util.cppdb]: { value: new addon.Database(filename, filenameGiven, anonymous, readonly, fileMustExist, timeout, verbose || null, buffer || null, { profile }) },
			...wrappers.getters,
		});
	}
	...
	const transaction = require('./methods/transaction');
	Database.prototype.transaction = transaction;
	Database.prototype.transactionAsync = transaction.async;
	...
	Database.prototype.execAsync = wrappers.execAsync;
...
function defineIteratorSymbols(addon) {
	Object.defineProperty(addon.StatementIterator.prototype, Symbol.iterator, {
		value: addon.StatementIterator.prototype.next[Symbol.for('better-sqlite3.iterator')] || function iterator() { return this; },
		writable: true,
		enumerable: true,
		configurable: true,
	});
	Object.defineProperty(addon.StatementAsyncIterator.prototype, Symbol.asyncIterator, {
		value: addon.StatementAsyncIterator.prototype.next[Symbol.for('better-sqlite3.asyncIterator')] || function asyncIterator() { return this; },
		writable: true,
		enumerable: true,
		configurable: true,
	});
